...
#File System 
 Accessing files in the Unix filesystem 
  1. Get the root of a path into an NSURL“Documents” directory or “Caches” directory or ... 
  2. Append path components to the URLThe names of your files (and the directories they reside in) 
  3. Write to/read from the filesUsually done with NSData or property list components. 
...
Winter 2015 
Core Data 
Visual MapThis is your database schema.
